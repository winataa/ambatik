...
module.exports = {
  async up (queryInterface, Sequelize) {
    ...
    */
      ...
      {
          name: 'Batik Truntum',
          url_batik: 'https://storage.googleapis.com/user-photo-profile/batik_photo/01_truntum.jpg',
      ...
      {
          name: 'Batik Tambal',
          url_batik: 'https://storage.googleapis.com/user-photo-profile/batik_photo/02_tambal.jpg',
          origin: 'Daerah Istimewa Yogyakarta',
      ...
      {
        name: 'Batik Sogan',
        url_batik: 'https://storage.googleapis.com/user-photo-profile/batik_photo/03_sogan.jpg',
      ...
      {
        name: 'Batik Simbut',
        url_batik: 'https://storage.googleapis.com/user-photo-profile/batik_photo/04_simbut.jpg',
        origin: 'Banten',
      ...
      },
      {
        ...
        url_batik: 'https://storage.googleapis.com/user-photo-profile/batik_photo/05_sekar_jagad.jpg',
      ...
      },
      {
        ...
        url_batik: 'https://storage.googleapis.com/user-photo-profile/batik_photo/06_pring_sedapur.jpg',
      ...
      {
        name: 'Batik Poleng',
        url_batik: 'https://storage.googleapis.com/user-photo-profile/batik_photo/07_poleng.jpg',
        origin: 'Bali',
      ...
      {
        name: 'Batik Parang',
        url_batik: 'https://storage.googleapis.com/user-photo-profile/batik_photo/08_parang.jpg',
        origin: 'Solo dan Yogyakarta',
      ...
      {
        name: 'Batik Nitik',
        url_batik: 'https://storage.googleapis.com/user-photo-profile/batik_photo/09_nitik.jpg',
        origin: 'Yogyakarta',
      ...
      },
      {
        ...
        url_batik: 'https://storage.googleapis.com/user-photo-profile/batik_photo/10_mega_mendung.jpg',
      ...
      {
        name: 'Batik Lasem',
        url_batik: 'https://storage.googleapis.com/user-photo-profile/batik_photo/11_lasem.jpg',
      ...
      {
        name: 'Batik Kawung',
        url_batik: 'https://storage.googleapis.com/user-photo-profile/batik_photo/12_kawung.png',
        origin: 'Yogyakarta',
      ...
      {
        name: 'Batik Insang',
        url_batik: 'https://storage.googleapis.com/user-photo-profile/batik_photo/13_insang.jpg',
        origin: 'Pontianak',
      ...
      },
      {
        ...
        url_batik: 'https://storage.googleapis.com/user-photo-profile/batik_photo/14_geblek_renteng.jpg',
      ...
      },
      {
        ...
        url_batik: 'https://storage.googleapis.com/user-photo-profile/batik_photo/15_cendrawasih.jpg',
        origin: 'Papua',
        meaning: 'Motif ini memiliki corak menyerupai daun talas dengan warna yang cerah. Berasal dari Suku Baduy di Banten, motif batik Simbut menyimpan filosofi tentang kedekatan manusia dengan alam sekitar. Ciri khas motif batik khas Banten ini adalah warnanya yang cenderung cerah, namun tetap tidak mencolok. Garis yang digunakan dalam motif batik simbut cenderung tebal dan berukuran besar.',
